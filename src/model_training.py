...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            # Sanitize both train and test feature names
            X_train = self.sanitize_column_names(X_train)
            X_test = self.sanitize_column_names(X_test)

            logger.info("Data split and sanitized successfully for Model Training")
